UI Tools Expansion pack: Outlook Style controls  v1.0.3
...
Description:
This package contains Outlook-style buttons with text.
Use especially as vertical toolbar selectors.

Includes:

- Set of Outlook-style controls
...
v1.0.3:  Removed a menu file that showed up incorrectly in the functions palette.
         
v1.0.2:  Initial release of the code. (8.6)
